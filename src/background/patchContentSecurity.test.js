...
it('should return new headers array with patched header', () => {
  const originalHeaders = [
    ...
    },
    {
      ...
      value: "default-src 'none'; img-src https://google.com; block-all-mixed-content; Upgrade-Insecure-Requests;"
    }
  ]
  ...
  const expectedHeaders = [
    ...
    {
      name: 'Content-Security-Policy',
      value: "default-src https://webtask.io 'none'; img-src https://webtask.io https://google.com; block-all-mixed-content; Upgrade-Insecure-Requests;"
    }
  ]
...
it('should strip out "block-all-mixed-content" CSP flag, if the proxyUrl protocol is http:', () => {
    ...
    {
      name: 'Content-Security-Policy',
      value: "default-src 'none'; img-src https://google.com; block-all-mixed-content; connect-src foobar.baz; upgrade-insecure-requests;"
    }
  ]
